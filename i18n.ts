...
const translations: Record<AppLanguage, TranslationMap> = {
  'en-US': {
    ...
    'sidebar.collapseNavigation': 'Collapse sidebar',
    'sidebar.expandNavigation': 'Expand sidebar',
    ...
    'dashboard.sectionMoveUp': 'Move section up',
    'dashboard.sectionMoveDown': 'Move section down',
    'dashboard.sectionMoveLeft': 'Move section left',
    'dashboard.sectionMoveRight': 'Move section right',
    'dashboard.sectionNarrow': 'Narrow section span',
    'dashboard.sectionWiden': 'Widen section span',
    'dashboard.sectionDelete': 'Delete section',
    'dashboard.closeDialog': 'Close dialog',
    ...
    'groups.batch.op.update_script_path_prefix': 'Update Script Folder',
    ...
    'groups.batch.pathPrefixNew': 'New Script Folder',
    'groups.batch.pathPrefixNewPlaceholder': '/new/folder',
    'groups.batch.pathPrefixHint':
      'Keep each selected script filename, and replace only its folder with this path.',
    'groups.batch.selectScriptFolder': 'Select Script Folder',
    ...
    'groups.batch.reason.path_prefix_new_required': 'New script folder is required.',
    'groups.batch.reason.path_filename_missing': 'Script path has no filename and was skipped.',
    ...
    'settings.desktopNotificationsEnabled': 'Desktop Notifications',
    'settings.desktopNotificationsEnabledDesc':
      'Control whether alert events can send desktop notifications. When disabled, only card UI indicators are shown.',
    'settings.desktopNotificationsOn': 'On',
    'settings.desktopNotificationsOff': 'Off',
    'settings.notificationPermission': 'Desktop Notification Permission',
    'settings.notificationPermissionDesc':
      'Request notification permission from the system and verify whether local notifications can be delivered.',
    ...
    'settings.notificationPermissionDeniedHint':
      'Permission denied. Enable notifications in your system notification settings.',
    ...
    'settings.scriptOutputFormat':
      'Script must output JSON to STDOUT: { "type": "scalar|series|status|gauge|digest", "data": {...} }',
    ...
    'cardShell.openMenu': 'Open card actions',
    'cardShell.closeMenu': 'Close card actions',
    ...
    'digest.doubleClickHint': 'Double-click to view full content',
    'digest.previewTitle': 'Digest Preview · {cardTitle}',
    'digest.previewSubtitle': 'Markdown Preview',
    'digest.untitledItem': 'Untitled #{index}',
    'alerts.notificationTitle': 'Card Alert · {cardTitle}',
    'alerts.statusChangedBody': '{cardTitle}: status changed from {from} to {to}',
    'alerts.contentChangedBody': '{cardTitle}: content updated',
    ...
    'exec.mappingDigestItemsNotArray': 'Mapping failed: digest items is not an array ({path})',
    'exec.mappingDigestTitleMissing': 'Mapping failed: digest items[{index}] title missing ({path})',
    'exec.mappingDigestBodyMissing': 'Mapping failed: digest items[{index}] body missing ({path})',
    ...
    'wizard.typeDigest': 'Digest',
    'wizard.typeDigestDesc': 'Grouped title and markdown body blocks',
    ...
    'wizard.seriesMode': 'Series Mode',
    'wizard.seriesModeHint': 'Double-line modes always use the first two series returned by script output.',
    'wizard.seriesMode.option.singleAxisSingleLine': 'Single Axis · Single Line',
    'wizard.seriesMode.option.singleAxisSingleLineDesc': 'Use one line on the left Y axis.',
    'wizard.seriesMode.option.singleAxisDoubleLine': 'Single Axis · Double Line',
    'wizard.seriesMode.option.singleAxisDoubleLineDesc': 'Use two lines sharing the left Y axis.',
    'wizard.seriesMode.option.dualAxisDoubleLine': 'Dual Axis · Double Line',
    'wizard.seriesMode.option.dualAxisDoubleLineDesc': 'Use left/right Y axes when ranges differ a lot.',
    ...
    'wizard.digestItemsKey': 'Items Key',
    'wizard.digestTitleKey': 'Item Title Key',
    'wizard.digestBodyKey': 'Item Body Key',
    ...
    'wizard.alerts.digestModeLabel': 'Digest trigger mode',
    'wizard.alerts.digestContentChange': 'Trigger when content updates',
    ...
    'wizard.seriesModePreview': 'Mode: {mode}',
    'wizard.seriesFallbackToSingleLine':
      'Configured as double-line, but only one series is available. Preview falls back to single-line.',
    'wizard.statusPreview': 'Status Preview',
    'wizard.gaugePreview': 'Gauge Preview',
    'wizard.digestPreview': 'Digest Preview',
    'wizard.digestItemsCount': 'Items: {count}',
    ...
    'wizard.validation.digestFields': 'Digest type requires items key, title key and body key',
    ...
    'series.fallbackToSingleLine': 'Configured as double-line, but only one series is available. Fallback to single-line.',
  },
  'zh-CN': {
    'common.all': '全部',
    'common.noData': '暂无数据',
    ...
    'sidebar.collapseNavigation': '收起侧边栏',
    'sidebar.expandNavigation': '展开侧边栏',
    ...
    'dashboard.sectionMoveUp': '分段上移',
    'dashboard.sectionMoveDown': '分段下移',
    'dashboard.sectionMoveLeft': '分段左移',
    'dashboard.sectionMoveRight': '分段右移',
    'dashboard.sectionNarrow': '缩小分段宽度',
    'dashboard.sectionWiden': '扩大分段宽度',
    'dashboard.sectionDelete': '删除分段',
    'dashboard.closeDialog': '关闭弹窗',
    ...
    'groups.batch.op.update_script_path_prefix': '批量修改脚本目录',
    ...
    'groups.batch.pathPrefixNew': '新脚本目录',
    'groups.batch.pathPrefixNewPlaceholder': '/新目录',
    'groups.batch.pathPrefixHint': '保留每张卡片当前脚本文件名，仅替换其目录为此路径。',
    'groups.batch.selectScriptFolder': '选择脚本目录',
    ...
    'groups.batch.reason.path_prefix_new_required': '必须填写新脚本目录。',
    'groups.batch.reason.path_filename_missing': '脚本路径缺少文件名，已跳过。',
    ...
    'settings.desktopNotificationsEnabled': '桌面通知发送',
    'settings.desktopNotificationsEnabledDesc': '控制告警是否发送桌面通知。关闭后仅保留卡片 UI 告警，不发送系统通知。',
    'settings.desktopNotificationsOn': '开启',
    'settings.desktopNotificationsOff': '关闭',
    'settings.notificationPermission': '桌面通知权限',
    'settings.notificationPermissionDesc': '向系统请求通知权限，并验证本地通知是否可达。',
    ...
    'settings.notificationPermissionDeniedHint': '权限被拒绝，请到系统通知设置中开启。',
    ...
    'settings.scriptOutputFormat':
      '脚本必须输出 JSON 到 STDOUT：{ "type": "scalar|series|status|gauge|digest", "data": {...} }',
    ...
    'cardShell.delete': '删除',
    'cardShell.openMenu': '打开卡片操作菜单',
    'cardShell.closeMenu': '关闭卡片操作菜单',
    ...
    'digest.doubleClickHint': '双击查看完整内容',
    'digest.previewTitle': '简报预览 · {cardTitle}',
    'digest.previewSubtitle': 'Markdown 预览',
    'digest.untitledItem': '未命名条目 #{index}',
    'alerts.notificationTitle': '卡片告警 · {cardTitle}',
    'alerts.statusChangedBody': '{cardTitle}：状态从 {from} 变为 {to}',
    'alerts.contentChangedBody': '{cardTitle}：内容已更新',
    ...
    'exec.mappingDigestItemsNotArray': '字段映射失败：digest items 不是数组（{path}）',
    'exec.mappingDigestTitleMissing': '字段映射失败：digest items[{index}] 缺少 title（{path}）',
    'exec.mappingDigestBodyMissing': '字段映射失败：digest items[{index}] 缺少 body（{path}）',
    ...
    'wizard.typeDigest': '简报',
    'wizard.typeDigestDesc': '标题+正文分组文本卡片',
    ...
    'wizard.seriesMode': '序列模式',
    'wizard.seriesModeHint': '双线模式固定使用脚本输出中的前两条 series。',
    'wizard.seriesMode.option.singleAxisSingleLine': '单轴 · 单线',
    'wizard.seriesMode.option.singleAxisSingleLineDesc': '使用左侧 Y 轴绘制 1 条线。',
    'wizard.seriesMode.option.singleAxisDoubleLine': '单轴 · 双线',
    'wizard.seriesMode.option.singleAxisDoubleLineDesc': '两条线共用左侧 Y 轴。',
    'wizard.seriesMode.option.dualAxisDoubleLine': '双轴 · 双线',
    'wizard.seriesMode.option.dualAxisDoubleLineDesc': '范围差距较大时使用左右双 Y 轴。',
    ...
    'wizard.digestItemsKey': 'Items 键',
    'wizard.digestTitleKey': '条目标题键',
    'wizard.digestBodyKey': '条目正文键',
    ...
    'wizard.alerts.digestModeLabel': '简报触发模式',
    'wizard.alerts.digestContentChange': '内容更新时触发',
    ...
    'wizard.seriesModePreview': '模式：{mode}',
    'wizard.seriesFallbackToSingleLine': '当前配置为双线，但脚本只返回了 1 条线，预览已回退为单线。',
    'wizard.statusPreview': '状态预览',
    'wizard.gaugePreview': '仪表盘预览',
    'wizard.digestPreview': '简报预览',
    'wizard.digestItemsCount': '条目数：{count}',
    ...
    'wizard.validation.digestFields': 'digest 类型必须设置 items key、title key 与 body key',
    ...
    'series.fallbackToSingleLine': '当前配置为双线，但脚本只返回了 1 条线，已回退为单线展示。',
  },
};
