...
const translations: Record<AppLanguage, TranslationMap> = {
  'en-US': {
    ...
    'groups.title': 'Group Management Center',
    ...
    'settings.backupFolderDesc': 'Backups are saved locally with timestamped file names.',
  ...
  'zh-CN': {
    ...
    'sidebar.groupManagement': '分组管理中心',
    ...
    'settings.backupFolderDesc': '备份文件保存在本地，文件名包含时间戳。',
